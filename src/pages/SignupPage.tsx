  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0f1a]">
        <div className="w-full max-w-sm space-y-4 p-8 rounded-xl border border-white/10 bg-[#0D1224] text-center">
          <div className="text-4xl">✉️</div>
          <h1 className="text-xl font-bold text-white">Check your email</h1>
          <p className="text-sm text-white/40">
            We sent a confirmation link to <strong className="text-white/70">{email}</strong>. Click the
            link to activate your account.
          </p>
          <Link
            to="/login"
            className="inline-block text-sm text-purple-400/60 hover:text-purple-400 font-medium transition-colors"
          >
            Back to sign in
          </Link>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0f1a]">
      <div className="w-full max-w-sm space-y-5 p-8 rounded-xl border border-white/10 bg-[#0D1224]">
        <div className="text-center">
          ...
          <p className="text-[12px] text-white/30 mt-1">Free during beta — unlock premium insights daily</p>
        </div>
        ...
        <p className="text-center text-[11px] text-white/25">
          ...
          <Link to="/login" className="text-purple-400/60 hover:text-purple-400 font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </div>
