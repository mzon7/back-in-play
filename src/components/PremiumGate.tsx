...
import { trackPremiumContentClick, trackPremiumUnlock, trackPremiumSignupPrompt } from "../lib/analytics";
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4" onClick={onClose}>
      ...
      >
        <div className="flex items-start justify-between mb-2">
          ...
          <button onClick={onClose} className="text-white/25 hover:text-white/50 text-sm leading-none ml-2 shrink-0">&times;</button>
        </div>
